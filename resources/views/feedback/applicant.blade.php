...
<html>
	...
	<body class="bg-gray-50">
		<div class="max-w-2xl mx-auto p-6">
			<h1 class="text-2xl font-semibold mb-4">Applicant Feedback</h1>
			...
			<form method="POST" action="{{ route('feedback.applicant.submit', ['hash' => $hash]) }}" class="bg-white rounded shadow p-4">
				@csrf
